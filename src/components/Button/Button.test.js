...
test("generates text, size and color", () => {
  const { getByText, rerender } = render(<Button text={button1.text} size={button1.size} color={button1.color} />);
  ...
  rerender(<Button text={button2.text} size={button2.size} color={button2.color} />);
